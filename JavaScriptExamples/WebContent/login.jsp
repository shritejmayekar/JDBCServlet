...
<body>
	<div class="flex-container">
		<form action="" method="post" onSubmit="return onClickValidate() ">
			...
			<div id="spaces">
				...
				<div class="flex-item">
					<label id="text" style="">Other Options</label> <a href="register.jsp">Register</a>
				</div>
			</div>
		</form>
	</div>
...
function onClickValidate() {
	if(document.getElementById("email").value=="/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/") {
		return true;
	}
