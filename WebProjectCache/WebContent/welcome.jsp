...
<body>
	...
	<div class="flex-conatiner">
		...
		out.print("<button type=submit style=margin-left:90% >Sign in</button>");
		}
		else {
		out.print("<form action=logout.jsp method=get>");
		out.print("<button type=submit style=margin-left:90% >Sign Out</button>");
		}%>
